...
import { updateDocumentCodeController } from '@modules/update-document-code';
import { rateDocumentController } from '@modules/rate-document/rate-document.controller';
import { deleteDocumentController } from '@modules/delete-document/delete-document.controller';
import { getPermanentDocumentsController } from '@modules/get-permanent-documents/get-permanent-documents.controller';
import { getAccessibleDocumentController } from '@modules/get-accessible-document/get-accessible-document.controller';
import { createDocumentController } from '@modules/create-document/create-document.controller';
import { getYourDocumentsController } from '@modules/get-your-documents/get-your-documents.controller';
import { updateDocumentNameController } from '@modules/update-document-name/update-document-name.controller';
